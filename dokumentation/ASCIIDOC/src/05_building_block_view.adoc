...
[role="arc42help"]
****
Beschreibung des esp32 anhand der folgenden Blackbox-Punkte:

_<Zweck/Verantwortung>_ +
Ist die Komponente zum Ansteueren der LEDs, Wärmesensoren, Beschleunigungssensoren, etc. +

_<Schnittstelle(n)>_ +
* I2c = Ansteuerung für Beschleunigungssensor +
* 1-wire = Ansteuerung für Wärmesensor +
* seriell = Ansteuerung für LEDs

==== <MQTT-Broker>

Beschreibung des MQTT-Brokers anhand der folgenden Blackbox-Punkte:

_<Zweck/Verantwortung>_ +
Ist die Komponente zum Erfassen der Daten und fungiert als Schnittstelle zwischen Client und Backend.

_<Schnittstelle(n)>_
* I2c = Ansteuerung für Beschleunigungs
* 1-wire = Ansteuerung für Wärmesensor
* seriell = Ansteuerung für LEDs
